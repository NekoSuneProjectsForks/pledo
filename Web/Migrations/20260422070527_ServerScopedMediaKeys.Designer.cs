...
namespace Web.Migrations
{
    ...
    [Migration("20260422070527_ServerScopedMediaKeys")]
    partial class ServerScopedMediaKeys
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Web.Models.Episode", b =>
                {
                    ...
                    b.HasKey("ServerId", "RatingKey");

                    b.HasIndex("ServerId", "TvShowId");
            ...
            modelBuilder.Entity("Web.Models.MediaFile", b =>
                {
                    ...
                    b.HasIndex("ServerId", "EpisodeRatingKey");

                    b.HasIndex("ServerId", "MovieRatingKey");
            ...
            modelBuilder.Entity("Web.Models.Episode", b =>
                {
                    b.HasOne("Web.Models.TvShow", "TvShow")
                        .WithMany("Episodes")
                        .HasForeignKey("ServerId", "TvShowId")
            ...
            modelBuilder.Entity("Web.Models.MediaFile", b =>
                {
                    b.HasOne("Web.Models.Episode", null)
                        .WithMany("MediaFiles")
                        .HasForeignKey("ServerId", "EpisodeRatingKey");

                    b.HasOne("Web.Models.Movie", null)
                        .WithMany("MediaFiles")
                        .HasForeignKey("ServerId", "MovieRatingKey");
                });
